...
func (b *BookResponse) FailedResponse(message string) JsonBookResponse {
	b.Response = JsonBookResponse{Type: "failed", StatusCode: 500, Data: []models.Book{}, Message: message}
	return b.Response
}

func (b *BookResponse) SuccessResponse(data []models.Book, message string) JsonBookResponse {
